...
namespace planning
{
  ...
  public:
    ...
    // find front and rear vehicle, constrain desired v, and desired s in gap.
    ...
    // calculate control output by IDM control.
    ...
    // calculate control output by ctxIDM control.
    ...
    // calculate control output by IDM control.
    // ! any difference with PropagateOnceAdvancedLK()?
